...
public class CurrencyConverter extends javax.swing.JFrame  {
	    ...
	    private void initComponents() {
	        ...
	        choiceFrom.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "INR", "USD", "EUR", "CNY", "KRW" }));
	        ...
	        choiceTo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "INR", "USD", "EUR", "CNY", "KRW" }));
	            ...
	            case "USD":
	                ...
	                switch (choiceTo.getSelectedItem().toString()) {
	                    ...
	                    case "KRW":
	                        ...
	                        output.setText(input.getText()+" USD = "+total+" KRW");
	                        break;
	                    default:
	                        total=amount*1;
	            ...
	            case "INR":
	                ...
	                switch (choiceTo.getSelectedItem().toString()) {
	                    ...
	                    case "KRW":
	                        ...
	                        output.setText(input.getText()+" INR = "+total+" KRW");
	                        break;
	                    default:
	                        total=amount*1;
	            ...
	            case "EUR":
	                ...
	                switch (choiceTo.getSelectedItem().toString()) {
	                    ...
	                    case "KRW":
	                        ...
	                        output.setText(input.getText()+" EUR = "+total+" KRW");
	                        break;
	                    default:
	                        total=amount*1;
	            ...
	            case "CNY":
	                ...
	                switch (choiceTo.getSelectedItem().toString()) {
	                    ...
	                    case "KRW":
	                        ...
	                        output.setText(input.getText()+" CNY = "+total+" KRW");
	                        break;
	                    default:
	                        total=amount*1;
	            ...
	            case "KRW":
	                ...
	                switch (choiceTo.getSelectedItem().toString()) {
	                    case "USD":
	                        ...
	                        output.setText(input.getText()+" KRW = "+total+" USD");
	                        break;
	                    case "INR":
	                        total=amount*1391685.7254;
	                        output.setText(input.getText()+" KRW = "+total+" INR");
	                        break;
	                    case "EUR":
	                        total=amount*15860.1393;
	                        output.setText(input.getText()+" KRW = "+total+" EUR");
	                        break;
	                    case "CNY":
	                        total=amount*115660.1311;
	                        output.setText(input.getText()+" KRW = "+total+" CNY");
	                        break;
	                    default:
	                        total=amount*1;
	                        output.setText(input.getText()+" KRW = "+total+" KRW");
	                        break;
	                }
	                break;
	        }
